...
<body style="font-family: 'Montserrat', sans-serif" id="didattica">
    <section class="px-6 py-2">
        <nav class="md:flex md:justify-between md:items-center">
            <div>
                <a href="/">
                    <img src="{{ asset("suffp.png") }}" alt="SUFFP" width="165" height="165">
                </a>
            </div>
            ...
            <div class="flex items-center mt-8 md:mt-0">
                @auth
                    <x-dropdown>
                        ...
                        @admin
                        <hr>
                        <x-dropdown-item href="{{ asset('storage/download/' . 'ManualeAmministratore.pdf') }}">
                            Guida per l'admin
                        </x-dropdown-item>
                        @endadmin
                        <x-dropdown-item href="{{ asset('storage/download/' . 'ManualeUtente.pdf') }}">
                            Guida per l'utente
                        </x-dropdown-item>
                        <hr>
                        <x-dropdown-item
